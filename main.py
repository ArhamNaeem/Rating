...
class RatingResponse(BaseModel):
    ...
    keyword_score: List[KeywordScore]
...
@app.post("/rating", response_model=RatingResponse)  # Change response_model to float
async def calculate_similarity(url_input: URLInput):
    ...
    for keyword in keywords:
       keyword_score.append(KeywordScore(keyword=keyword, score=random.randint(0,10)))
       print(keyword)


    return RatingResponse(similarity_score=similarity_score, keyword_score=keyword_score)
